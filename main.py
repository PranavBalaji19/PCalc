...
class MyGrid(GridLayout):
    def __init__(self,**kwargs):
        ...
        self.heading = Label(text="Welcome to PCalc!!!",font_size=50)
        self.output.add_widget(self.heading)
        
        self.output_screen = TextInput(text='0',multiline=False,halign="right",font_size=50)
        ...
        self.sine = Button(text = 'sin',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.arcsine = Button(text = 'arcsin',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.remainder = Button(text = '%',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.operator)
        self.gap1 = Label()
        self.bksp = Button(text = '<-',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.bk)
        self.clear = Button(text = 'C',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.cl)
        self.absval = Button(text = '|x|',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.ab)
        self.divide = Button(text = '/',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.operator)
        
        self.cosine = Button(text = 'cos',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.arccosine = Button(text = 'arccos',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.square = Button(text = 'x^2',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.sqr)
        self.gap2 = Label()
        self.seven = Button(text = '7',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.eight = Button(text = '8',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.nine = Button(text = '9',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.multiply = Button(text = '*',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.operator)

        self.tangent = Button(text = 'tan',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.arctangent = Button(text = 'arctan',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.trig)
        self.root = Button(text = 'sqrt',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.sqrt)
        self.gap3 = Label()
        self.four = Button(text = '4',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.five = Button(text = '5',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.six = Button(text = '6',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.subtract = Button(text = '-',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.operator)

        self.pival = Button(text = 'pi',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.pi)
        self.epowx = Button(text = 'e^x',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.epowerx)
        self.gifx = Button(text = '[x]',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.gif)
        self.gap4 = Label()
        self.one = Button(text = '1',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.two = Button(text = '2',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.three = Button(text = '3',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.add = Button(text = '+',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.operator)

        self.logx = Button(text = 'log(x)',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.logarithm)
        self.tenpowx = Button(text = '10^x',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.tenpowerx)
        self.xfact = Button(text = 'x!',background_color =(0.3, 0.3, 0.3, 1),font_size=20,on_press=self.fact)
        self.gap5 = Label()
        self.dot = Button(text = '.',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.dt)
        self.zero = Button(text = '0',background_color =(0.1, 0.1, 0.1, 1),font_size=30,on_press=self.number)
        self.negate = Button(text = '+/-',background_color =(0.3, 0.3, 0.3, 1),font_size=30,on_press=self.ng)
        self.equal = Button(text = '=',background_color =(0, 1, 0, 1),font_size=30,on_press=self.equate)
    ...
    def operator(self, instance):
        if str(instance.text) in self.operators:
            if str(self.output_screen.text) in ('invalid input!','cannot divide by zero!','Overflow!'):
                self.output_screen.text = '0'+str(instance.text)
            else:
                if str(self.output_screen.text)[-1] not in self.operators:
                    self.equate(self)
                    self.output_screen.text = str(self.output_screen.text)+str(instance.text)
                elif str(self.output_screen.text) in ('invalid input!','cannot divide by zero!','Overflow!'):
                    self.output_screen.text = '0'+str(instance.text)
                else:
                    self.output_screen.text = str(self.output_screen.text)[:-1]+str(instance.text)
        self.last_was_operator=None
    ...
    def sqrt(self, instance):
        try:
            self.equate(self)
            s = float(self.output_screen.text)**0.5
            if type(s)==complex:
                self.output_screen.text = "invalid input!"
            else:
